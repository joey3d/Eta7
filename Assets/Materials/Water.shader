...
#define _Roughness_arr BoomerangWater
		...
		{
			float2 uv_TexCoord5 = i.uv_texcoord * float2( 225,225 );
			float2 panner6 = ( 1.0 * _Time.y * float2( 0.05,0.03 ) + uv_TexCoord5);
			float2 uv_TexCoord7 = i.uv_texcoord * float2( 250,250 );
			float2 panner8 = ( 1.0 * _Time.y * float2( -0.05,0.02 ) + uv_TexCoord7);
...
/*ASEBEGIN
Version=15401
2869;69;970;824;1640.394;1065.401;2.245001;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;7;-984.0441,-69.20925;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;250,250;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;5;-986.5854,-425.1991;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;225,225;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;6;-754.1475,-425.1992;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.05,0.03;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;8;-751.6051,-69.2094;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.05,0.02;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-73.1993,-75.92567;Float;False;InstancedProperty;_Roughness;Roughness;2;0;Create;True;0;0;False;0;0;0.75;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C109FA23CA3A8016FA036DFBB51854FD2CBE1EF1